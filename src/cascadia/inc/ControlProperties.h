...
#define CONTROL_SETTINGS(X)                                                                                                                              \
    ...
    X(winrt::Microsoft::Terminal::Control::SerialBoundRate, BoundRate, winrt::Microsoft::Terminal::Control::SerialBoundRate::Spd115200)                  \
    X(winrt::Microsoft::Terminal::Control::SerialDataWidth, DataWidth, winrt::Microsoft::Terminal::Control::SerialDataWidth::W8)                         \
    X(winrt::Microsoft::Terminal::Control::SerialCheckBit, CheckBit, winrt::Microsoft::Terminal::Control::SerialCheckBit::None)                          \
    X(winrt::Microsoft::Terminal::Control::SerialStopBit, StopBit, winrt::Microsoft::Terminal::Control::SerialStopBit::S1)                               \
    X(winrt::Microsoft::Terminal::Control::SerialFlowControl, FlowControl, winrt::Microsoft::Terminal::Control::SerialFlowControl::XONORXOFF)
