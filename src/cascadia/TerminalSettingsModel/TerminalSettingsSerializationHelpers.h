...
// Serial enum
JSON_ENUM_MAPPER(::winrt::Microsoft::Terminal::Control::SerialBoundRate)
{
    static constexpr std::array<pair_type, 16> mappings = {
        pair_type{ "spd921600", ValueType::Spd921600 },
        pair_type{ "spd460800", ValueType::Spd460800 },
        pair_type{ "spd380400", ValueType::Spd380400 },
        pair_type{ "spd230400", ValueType::Spd230400 },
        pair_type{ "spd115200", ValueType::Spd115200 },
        pair_type{ "spd57600", ValueType::Spd57600 },
        pair_type{ "spd38400", ValueType::Spd38400 },
        pair_type{ "spd19200", ValueType::Spd19200 },
        pair_type{ "spd14400", ValueType::Spd14400 },
        pair_type{ "spd9600", ValueType::Spd9600 },
        pair_type{ "spd4800", ValueType::Spd4800 },
        pair_type{ "spd2400", ValueType::Spd2400 },
        pair_type{ "spd1200", ValueType::Spd1200 },
        pair_type{ "spd600", ValueType::Spd600 },
        pair_type{ "spd300", ValueType::Spd300 },
        pair_type{ "spd100", ValueType::Spd100 },
    };
};

JSON_ENUM_MAPPER(::winrt::Microsoft::Terminal::Control::SerialDataWidth)
{
    static constexpr std::array<pair_type, 4> mappings = {
        pair_type{ "w5", ValueType::W5 },
        pair_type{ "w6", ValueType::W6 },
        pair_type{ "w7", ValueType::W7 },
        pair_type{ "w8", ValueType::W8 },
     };
};

JSON_ENUM_MAPPER(::winrt::Microsoft::Terminal::Control::SerialCheckBit)
{
    static constexpr std::array<pair_type, 5> mappings = {
        pair_type{ "none", ValueType::None },
        pair_type{ "odd", ValueType::Odd },
        pair_type{ "even", ValueType::Even },
        pair_type{ "mark", ValueType::Mark },
        pair_type{ "space", ValueType::Space },
    };
};

JSON_ENUM_MAPPER(::winrt::Microsoft::Terminal::Control::SerialStopBit)
{
    static constexpr std::array<pair_type, 3> mappings = {
        pair_type{ "s1", ValueType::S1 },
        pair_type{ "s1_5", ValueType::S1_5 },
        pair_type{ "s2", ValueType::S2 },        
    };
};

JSON_ENUM_MAPPER(::winrt::Microsoft::Terminal::Control::SerialFlowControl)
{
    static constexpr std::array<pair_type, 3> mappings = {
        pair_type{ "xONORXOFF", ValueType::XONORXOFF },
        pair_type{ "dTRORDSR", ValueType::DTRORDSR },
        pair_type{ "rTSORCTS", ValueType::RTSORCTS },        
    };
};
