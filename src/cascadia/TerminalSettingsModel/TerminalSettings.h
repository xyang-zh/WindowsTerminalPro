...
namespace winrt::Microsoft::Terminal::Settings::Model::implementation
{
    ...
    struct TerminalSettings : TerminalSettingsT<TerminalSettings>, IInheritable<TerminalSettings>
    {
        ...
        // serial setting        
        INHERITABLE_SETTING(Model::TerminalSettings, Microsoft::Terminal::Control::SerialBoundRate, BoundRate, Microsoft::Terminal::Control::SerialBoundRate::Spd115200);
        INHERITABLE_SETTING(Model::TerminalSettings, Microsoft::Terminal::Control::SerialDataWidth, DataWidth, Microsoft::Terminal::Control::SerialDataWidth::W8);
        INHERITABLE_SETTING(Model::TerminalSettings, Microsoft::Terminal::Control::SerialCheckBit, CheckBit, Microsoft::Terminal::Control::SerialCheckBit::None);
        INHERITABLE_SETTING(Model::TerminalSettings, Microsoft::Terminal::Control::SerialStopBit, StopBit, Microsoft::Terminal::Control::SerialStopBit::S1);
        INHERITABLE_SETTING(Model::TerminalSettings, Microsoft::Terminal::Control::SerialFlowControl, FlowControl, Microsoft::Terminal::Control::SerialFlowControl::XONORXOFF);
        INHERITABLE_SETTING(Model::TerminalSettings, hstring, SerialPort, L"");
