...
namespace winrt::Microsoft::Terminal::Settings::Model::implementation
{
    ...
    // Serial Settings
    DEFINE_ENUM_MAP(Microsoft::Terminal::Control::SerialBoundRate, SerialBoundRate);
    DEFINE_ENUM_MAP(Microsoft::Terminal::Control::SerialDataWidth, SerialDataWidth);
    DEFINE_ENUM_MAP(Microsoft::Terminal::Control::SerialCheckBit, SerialCheckBit);
    DEFINE_ENUM_MAP(Microsoft::Terminal::Control::SerialStopBit, SerialStopBit);
    DEFINE_ENUM_MAP(Microsoft::Terminal::Control::SerialFlowControl, SerialFlowControl);    
