...
#define MTSM_PROFILE_SETTINGS(X)                                                                                                                               \
    ...
    X(Microsoft::Terminal::Control::SerialBoundRate, BoundRate, "serialBoundRate", Microsoft::Terminal::Control::SerialBoundRate::Spd115200)                   \
    X(Microsoft::Terminal::Control::SerialDataWidth, DataWidth, "serialDataWidth", Microsoft::Terminal::Control::SerialDataWidth::W8)                          \
    X(Microsoft::Terminal::Control::SerialCheckBit, CheckBit, "serialCheckBit", Microsoft::Terminal::Control::SerialCheckBit::None)                            \
    X(Microsoft::Terminal::Control::SerialStopBit, StopBit, "serialStopBit", Microsoft::Terminal::Control::SerialStopBit::S1)                                  \
    X(Microsoft::Terminal::Control::SerialFlowControl, FlowControl, "serialFlowControl", Microsoft::Terminal::Control::SerialFlowControl::XONORXOFF)           \
    X(hstring, SerialPort, "serialPort", L"")                                                                                                                  \
    X(bool, SerialEnable, "serialEnable", false)
